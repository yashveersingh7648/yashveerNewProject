...
<Helmet>
  {/* SEO-Optimized Title */}
  <title>Privacy Policy | CipherERP - Your Data Protection & Security</title>

  {/* Meta Description for SEO Ranking */}
  <meta 
    name="description" 
    content="Learn how CipherERP protects your personal data with strict security measures. Read our Privacy Policy to understand how we collect, use, and safeguard your information." 
  />

  {/* SEO-friendly Meta Keywords */}
  <meta 
    name="keywords" 
    content="Privacy Policy, CipherERP data protection, user data security, personal information safety, GDPR compliance, online privacy, cookie policy"
  />
</Helmet>
...
<ScrollToTopButton/>
    ...
    <div className='container-fluid'>
      <div className="container mx-auto mt-20 pray" id='head'>
      <h1 className="text-center font-bold text-4xl underline mb-4 drop-shadow-2xl text-indigo-900">
    Protecting Your Personal Data & Privacy with Secure Solutions
</h1>
    ...
    <div className="container mx-auto mt-20 fonts">
        <p>
            Our Privacy Policy given below:

            The terms "We" / "Us" / "Our"/”Company” individually and collectively refer to Ciphershild Technology and the
            ...
            electronic documents / records in various statutes as amended by the information Technology Act, 2000. This
            Privacy Policy does not require any physical, electronic or digital signature.

            This Privacy Policy is a legally binding document between you and Ciphershild Technology (both terms defined
            below). The terms of this Privacy Policy will be effective upon your acceptance of the same (directly or
            indirectly in electronic form, by clicking on the I accept tab or by use of the website or by other means)
            and will govern the relationship between you and Ciphershild Technology for your use of the website “Website”
            (www.ciphershieldtech.com.com).
            ...
            consent to this Privacy Policy. If you do not agree with the terms of this Privacy Policy, please do not use
            this Website.
    ...
    <div className="container mx-auto mt-20">
        <h2 className=" text-center font-bold f1 text-4xl underline mb-4 drop-shadow-2xl text-indigo-900">User Information Collection</h2>
    </div>
    ...
    <div className="container mx-auto mt-20">
        <h2 className=" text-center font-bold f1 text-4xl underline mb-4 drop-shadow-2xl text-indigo-900">Use of Cookies</h2>
    </div>
    ...
    <div className="container mx-auto mt-20">
        <h2 className=" text-center font-bold f1 text-4xl underline mb-4 drop-shadow-2xl text-indigo-900">Links to Other Websites</h2>
    </div>
    ...
    <div className="container mx-auto mt-20">
        <h2 className=" text-center font-bold f1 text-4xl underline mb-4 drop-shadow-2xl text-indigo-900">Information Sharing with Third Parties</h2>
    </div>
    ...
    <div className="container mx-auto mt-20 fonts">
        <p>
            Redressal Mechanism: Any complaints, abuse or concerns with regards to content and or comment or breach of these terms shall be immediately informed to the designated Grievance Officer as mentioned below via in writing or through email signed with the electronic signature to Devendra Pal Singh ("Grievance Officer").

            Mr. Devendra Pal Singh (Grievance Officer)
            www.ciphershieldtech.com
            Company Name & Address
            CipherShield Technology
            J.S. Arcade, Sec - 18, Noida
            Email: support@ciphererp.com,
            Ph: 8882171554, +91 1204375355
        </p>
    </div>
    </div>
<ChatbotComponent />

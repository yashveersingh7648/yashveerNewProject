...
const ReturnPolicy = () => {
  return (
   ...
   <Helmet>
  {/* SEO-optimized Title */}
  <title>Return & Refund Policy | CipherERP - Hassle-Free Product Returns</title>

  {/* Meta description optimized for ranking */}
  <meta 
    name="description" 
    content="Review CipherERP's return & refund policy. Learn about our hassle-free product returns, exchanges, and refund process for seamless customer service." 
  />

  {/* SEO-focused meta keywords */}
  <meta 
    name="keywords" 
    content="CipherERP return policy, product returns, refunds, exchanges, return conditions, return process, customer satisfaction, refund guidelines, easy returns"
  />
</Helmet>
...
<ScrollToTopButton/>
    ...
    <div className='container-fluid'>
       <div className="container mx-auto mt-20" id='head'>
       <h1 className="text-center font-bold text-4xl underline mb-4 drop-shadow-2xl text-indigo-900">
    Return Policy & Terms: Hassle-Free Shopping with CipherERP
</h1>
    ...
    <div className="container mx-auto mt-20 fonts">
        <p>
            The terms "We" / "Us" / "Our"/”Company” individually and collectively refer to Ciphershild Technology and the terms
            "Visitor” ”User” refer to the users.

            This page states the Terms and Conditions under which you (Visitor) may visit this website
            (“www.ciphershieldtech.com”). Please read this page carefully. If you do not accept the Terms and Conditions
            stated here, we would request you to exit this site. The business, any of its business divisions and / or
            its subsidiaries, associate companies or subsidiaries to subsidiaries or such other investment companies (in
    ...
    <div className="container mx-auto mt-20 fonts">
        <p>
            The User unilaterally agree to indemnify and hold harmless, without objection, the Company, its officers, directors, employees and agents from and against any claims, actions and/or demands and/or liabilities and/or losses and/or damages whatsoever arising from or resulting from their use of www.ciphershieldtech.com or their breach of the terms .
        </p>
    </div>
